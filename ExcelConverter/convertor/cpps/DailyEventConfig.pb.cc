...
void protobuf_AddDesc_DailyEventConfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\026DailyEventConfig.proto\032\025GroupTypeConfi"
    "g.proto\"Z\n\020DailyEventConfig\022\n\n\002id\030\001 \002(\005\022"
    "\021\n\topen_time\030\002 \002(\005\022\022\n\nclose_time\030\003 \002(\005\022\023"
    "\n\013activity_id\030\004 \002(\005", 139);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_close_time;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_activity_id;
        break;
      }
...
void DailyEventConfig::SerializeWithCachedSizes(
  ...
  // required int32 close_time = 3;
  if (has_close_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->close_time(), output);
  }

  // required int32 activity_id = 4;
  if (has_activity_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->activity_id(), output);
  }
...
::google::protobuf::uint8* DailyEventConfig::SerializeWithCachedSizesToArray(
  ...
  // required int32 close_time = 3;
  if (has_close_time()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->close_time(), target);
  }

  // required int32 activity_id = 4;
  if (has_activity_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->activity_id(), target);
  }
