...
void protobuf_AssignDesc_ActivityConfig_2eproto() {
  ...
  static const int ActivityConfig_offsets_[19] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ActivityConfig, kk_),
...
void protobuf_AddDesc_ActivityConfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024ActivityConfig.proto\032\025GroupTypeConfig."
    "proto\"\204\003\n\016ActivityConfig\022\025\n\ractivity_sho"
    "w\030\001 \003(\005\022\020\n\010act_type\030\002 \002(\005\022\021\n\topen_date\030\003"
    " \002(\005\022\020\n\010hot_type\030\004 \002(\005\022\014\n\004rule\030\005 \002(\t\022\021\n\t"
    "week_date\030\006 \003(\005\022\022\n\nclose_date\030\007 \002(\005\022\021\n\ts"
    "howornot\030\010 \002(\005\022\n\n\002id\030\t \002(\005\022\021\n\ttitle_res\030"
    "\n \002(\005\022\023\n\013activity_id\030\013 \002(\005\022\014\n\004desc\030\014 \002(\t"
    "\022\025\n\ractivity_drop\030\r \003(\005\022\021\n\tshow_type\030\016 \002"
    "(\005\022\020\n\010showrule\030\017 \002(\005\022\034\n\002kk\030\020 \003(\0132\020.Group"
    "TypeConfig\022\026\n\016act_same_index\030\021 \002(\005\022\021\n\tda"
    "te_type\030\022 \002(\005\022\025\n\ractivity_name\030\023 \002(\t", 436);
...
const int ActivityConfig::kKkFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_activity_show:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                 ...
                 1, 8, input, this->mutable_activity_show())));
        ...
        if (input->ExpectTag(8)) goto parse_activity_show;
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_open_date;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_hot_type;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_rule;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_week_date;
        break;
      }
      ...
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_week_date:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 48, input, this->mutable_week_date())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_showornot;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(80)) goto parse_title_res;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_activity_id;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(104)) goto parse_activity_drop;
        break;
      }
      ...
      case 13: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_activity_drop:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 104, input, this->mutable_activity_drop())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
      ...
      case 14: {
        ...
        if (input->ExpectTag(120)) goto parse_showrule;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(130)) goto parse_kk;
        break;
      }
      ...
      case 16: {
        ...
        if (input->ExpectTag(130)) goto parse_kk;
        if (input->ExpectTag(136)) goto parse_act_same_index;
        break;
      }
      ...
      case 17: {
        ...
        if (input->ExpectTag(144)) goto parse_date_type;
        break;
      }
      ...
      case 18: {
        ...
        if (input->ExpectTag(154)) goto parse_activity_name;
        break;
      }
...
void ActivityConfig::SerializeWithCachedSizes(
  ...
  // required int32 open_date = 3;
  if (has_open_date()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->open_date(), output);
  }

  // required int32 hot_type = 4;
  if (has_hot_type()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->hot_type(), output);
  }
  ...
  // required int32 showornot = 8;
  if (has_showornot()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->showornot(), output);
  }
  ...
  // required int32 title_res = 10;
  if (has_title_res()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(10, this->title_res(), output);
  }

  // required int32 activity_id = 11;
  if (has_activity_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(11, this->activity_id(), output);
  }
  ...
  for (int i = 0; i < this->activity_drop_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      13, this->activity_drop(i), output);
  }
  ...
  // required int32 showrule = 15;
  if (has_showrule()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(15, this->showrule(), output);
  }

  // repeated .GroupTypeConfig kk = 16;
  for (int i = 0; i < this->kk_size(); i++) {
  ...
  if (has_act_same_index()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(17, this->act_same_index(), output);
  }

  // required int32 date_type = 18;
  if (has_date_type()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(18, this->date_type(), output);
  }
...
::google::protobuf::uint8* ActivityConfig::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->activity_show_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(1, this->activity_show(i), target);
  }
  ...
  // required int32 open_date = 3;
  if (has_open_date()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->open_date(), target);
  }

  // required int32 hot_type = 4;
  if (has_hot_type()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->hot_type(), target);
  }
  ...
  for (int i = 0; i < this->week_date_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(6, this->week_date(i), target);
  }
  ...
  // required int32 showornot = 8;
  if (has_showornot()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->showornot(), target);
  }
  ...
  // required int32 title_res = 10;
  if (has_title_res()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(10, this->title_res(), target);
  }

  // required int32 activity_id = 11;
  if (has_activity_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(11, this->activity_id(), target);
  }
  ...
  for (int i = 0; i < this->activity_drop_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(13, this->activity_drop(i), target);
  }
  ...
  // required int32 showrule = 15;
  if (has_showrule()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(15, this->showrule(), target);
  }
  ...
  // required int32 act_same_index = 17;
  if (has_act_same_index()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(17, this->act_same_index(), target);
  }

  // required int32 date_type = 18;
  if (has_date_type()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(18, this->date_type(), target);
  }
...
bool ActivityConfig::IsInitialized() const {
  if ((_has_bits_[0] & 0x00076fde) != 0x00076fde) return false;
